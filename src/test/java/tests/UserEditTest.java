...
public class UserEditTest extends BaseTestCase {
    ...
    public void testEditJustCreated() {
        ...
        Response responseEditUser = apiCoreRequests
                .makePutRequest("https://playground.learnqa.ru/api/user/" + userIdOnAuth, editData,
                        header, cookie);
    ...
    public void testEditUserNotAuth() {
        ...
        Response responseEditUser = apiCoreRequests
                .makePutRequestWithoutHeaderAndCookie("https://playground.learnqa.ru/api/user/" + userIdOnAuth,
                        editData);
        ...
        //GET
        Response responseAfterEditing = apiCoreRequests
                .makeGetRequest("https://playground.learnqa.ru/api/user/" + userIdOnAuth,
    ...
    public void testEditUserWithAnotherAuth() {
        ...
        Response responseEditUser = apiCoreRequests.makePutRequest("https://playground.learnqa.ru/api/user/" + userIdOnAuth,
